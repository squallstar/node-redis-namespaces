...
Please note: I didn't write this library but rather just forked it
and later just borrowed as a new npm package, since it was dead.

Original author: Aaron Schlesinger
https://github.com/arschles/node-redis-namespace
...
var NO_KEY = -1, //no argument to a function is a key
    ...
    NOT_IMPLEMENTED = 6; //have't represented this key pattern yet
